...
import map11 from '~/assets/map/map11';
import map13 from '~/assets/map/map13';
import map15 from '~/assets/map/map15';
import map2 from '~/assets/map/map2';
import map8 from '~/assets/map/map8';
import map9 from '~/assets/map/map9';
